...
#recipes.remove(<cavern:cavenic_sword>);
recipes.remove(<cavern:cavenic_axe>);
#recipes.remove(<cavern:cavenic_bow>);
...
recipes.addShaped(<minecraft:bucket>, [[null, null, null],
[<minecraft:iron_ingot>, null, <minecraft:iron_ingot>], 
[null, <minecraft:iron_ingot>, null]]);

/* 
recipes.remove(<aether_legacy:valkyrie_helmet>);
recipes.remove(<aether_legacy:valkyrie_chestplate>);
recipes.remove(<aether_legacy:valkyrie_leggings>);
recipes.remove(<aether_legacy:valkyrie_boots>);
...
recipes.remove(<aether_legacy:valkyrie_lance>);
 */
